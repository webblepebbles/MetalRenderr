...
JNIEXPORT jlong JNICALL Java_com_metalrender_nativebridge_MetalBackend_initNative(JNIEnv*, jclass, jlong, jboolean);
...
JNIEXPORT void JNICALL Java_com_metalrender_nativebridge_MetalBackend_uploadStaticMesh(JNIEnv*, jclass, jlong, jobject,
                                                                                       jint, jint);
