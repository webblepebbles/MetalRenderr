...
public final class GLIntercept {
    ...
    private static final ThreadLocal<Integer> boundVbo = ThreadLocal.withInitial(() -> { return 0; });
    private static final ThreadLocal<Integer> boundIbo = ThreadLocal.withInitial(() -> { return 0; });
    ...
    private static final RenderBackend NO_OP_BACKEND = new GLIntercept.NoOpRenderBackend();
