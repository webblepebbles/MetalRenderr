...
public final class NativeBridge {
    ...
    public static native void nQueueIndirectDraw(
        long var0, int var2, long var3, long var5, int var7, int var8, int var9, int var10, int var11, float var12);
    ...
    public static native void nSetTemporalJitter(long var0, float var2, float var3, float var4);

    public static native boolean nSupportsMetalFX();

    public static native void nSetMetalFXEnabled(long var0, boolean var2);

    public static native void nConfigureMetalFX(long var0, int var2, int var3, float var4);
    ...
    static {
        try {
            ...
            System.err.println("[MetalRender] java.library.path=" + System.getProperty("java.library.path"));
        } catch (Throwable var1) {
            libLoaded = false;
            System.err.println("[MetalRender] Failed to load native library: " + var1);
